  ...
  experiences: [
    {
      ...
      jobDescription: [ "Offer engineering services in projects such as: Robotic Control System Design & Software development (C/C++/Matlab); Mechanical design of movie props (Solidworks), Software Translation (C++/Python/Matlab)", "Offer consulting expertise in Multiple S/W & H/W functional testing projects for products, applications & websites from Amazon, Google, Slack, Applause & others. Report results of debug logs & visual feedback.", "Sales & Marketing: Making bids, setting terms & prices, developing and implementing online marketing strategies","Make 3D printed products on request & sell them. (COVID19: Adult Protective Face Gear, Adult Protect Chin Gear, Children Protective Face Gear)"]
    },
    {
